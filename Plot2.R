...
png(filename ="E:\\johns hopkins\\Exploring Data GitHub\\plot2.png",width = 480,height = 480,units = "px")
g<- ggplot(data = file2,mapping = aes(x = file2$date_time,y = file2$Global_active_power))
g+geom_line()+scale_x_datetime(date_labels = "%a %d,%Y")+xlab(label = "")+ylab(label = "Global active power(kilowatts)")
dev.off()
# end of plot2
